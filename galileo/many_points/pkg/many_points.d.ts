...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5c7a4ede36a7bbaa: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h05dda599a9808b3b: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h0a5390283c061485: (a: number, b: number, c: number, d: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h268b9835fcc7760f: (a: number, b: number) => void;
