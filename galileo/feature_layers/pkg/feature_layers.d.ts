...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h033c0c1bda195bf5: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hfd0a042edee9ca35: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h94a026090e05c954: (a: number, b: number, c: number, d: number) => void;
