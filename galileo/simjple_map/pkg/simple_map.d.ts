...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h01f57c2d21b4028f: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hd0f97a33e8e40f48: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h8359e567f6d5cf37: (a: number, b: number, c: number, d: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2deb06af12ee5387: (a: number, b: number) => void;
